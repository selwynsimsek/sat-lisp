...
(cffi:defcfun (%ipasir-release "ipasir_release") :void (solver :pointer))
...
(cffi:defcfun (%ipasir-add "ipasir_add") :void (solver :pointer) (lit-or-zero :int32))
...
(cffi:defcfun (%ipasir-assume "ipasir_assume") :void (solver :pointer) (lit :int32))
...
(cffi:defcfun (%ipasir-solve "ipasir_solve") :int (solver :pointer))
...
(cffi:defcfun (%ipasir-val "ipasir_val") :int32 (solver :pointer) (lit :int32))
...
(cffi:defcfun (%ipasir-failed "ipasir_failed") :int (solver :pointer) (lit :int32))
...
(cffi:defcfun (%ipasir-set-terminate "ipasir_set_terminate") :void (solver :pointer) (data :pointer) (terminate :pointer))

(cffi:defcallback example-terminate :int ((data :pointer))
  (declare (ignore data))
  ;(format *error-output* "in example-terminate: returning 0~%")
  0)
...
(cffi:defcfun (%ipasir-set-learn "ipasir_set_learn") :void (solver :pointer) (data :pointer) (max-length :int) (learn :pointer))
...
(cffi:defcfun (%mallob-ipasir-init "mallob_ipasir_init") :pointer (incremental :boolean))
...
(cffi:defcfun (%mallob-ipasir-branched-solve "mallob_ipasir_branched_solve")
    :void (solver :pointer) (data :pointer) (terminate :pointer) (callback-done :pointer))
...
(cffi:defcfun (%mallob-ipasir-presubmit "mallob_ipasir_presubmit") :void (solver :pointer))
